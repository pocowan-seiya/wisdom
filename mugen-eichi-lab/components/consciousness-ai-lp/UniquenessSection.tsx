...
const uniquenessData: UniquenessItem[] = [
    ...
    },
    {
        ...
        description: [
            ...
            'そんな僕たちの意識が反映されたサービス、システム、仕組み、形——AIというバックアップを使って、穏やかに具現化していく。',
            'そうやって創ったものから放たれる電波もまた、その意識の電波になっていく。',
            '意識がシフトすると、ひらめきが変わる。ひらめきが変われば、創るものが変わる。それが当たり前に起きていく——これが、僕たちの意識の持つ本来の力です。',
