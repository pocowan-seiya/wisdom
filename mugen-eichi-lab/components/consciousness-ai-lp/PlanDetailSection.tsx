...
const planDetails: PlanDetail[] = [
    {
        ...
        accentColor: '#c9a84c',
        description: [
            '「AI×ビジョンの実践に、毎月触れていきたい」——まずはここから。',
            '月2回のAI実践セミナーで最新ツールに触れ、月1回のビジョンセッションで自分のビジョンを言語化・深めていく。Discordコミュニティでは仲間と実践を共有し、せいやからのリアルタイム発信で最新をキャッチアップ。',
            'AI×ビジョンの実践を、無理なく日常のリズムに組み込んでいくベースプランです。',
        ],
        highlights: [
            {
                icon: '⚡',
                title: 'AI実践セミナー（月2回）',
                detail: '各90分、録画あり。最新AIツールの実演とせいやの実践デモをリアルタイムで体験。',
            },
            {
                icon: '🌿',
                title: 'ビジョンセッション（月1回）',
                detail: '無限の可能性のビジョンで存在するワーク。自分のビジョンを言語化し、深めていく時間。',
            },
            {
                icon: '📹',
                title: 'AI実践共有動画（週1回）',
        ...
        whoIsItFor: [
            'AI×ビジョンの実践を、日常のリズムに組み込みたい方',
            '自分のビジョンを言語化・深めていきたい方',
            '毎月のセミナーで最新AIに触れていきたい方',
            'まずは場のエネルギーを感じながら、コミュニティに入りたい方',
        ],
    },
    {
        id: 'accelerate',
        ...
        accentColor: '#7c5cbf',
        description: [
            '「自分のビジネスで、AIを本気で動かしたい」——加速したいあなたへ。',
            'スタンダードプランの全てに加え、少人数ZoomでAI自動化システム構築を一緒にサポート。自分のビジネスに合わせたAIワークフロー・自律化チームを設計・構築していきます。',
            'せいやへの直接チャット質問もOK。最新AIツールも会員価格（30〜50% OFF）で利用可能。',
            'AIを「学ぶ」から「自分のビジネスで動かす」へ。その加速装置となるプランです。',
        ],
        highlights: [
            {
                icon: '🔧',
                title: 'AI自動化システム構築サポート（少人数Zoom）',
                detail: '自分のビジネスに合わせて、AIワークフロー・自律化チームを一緒に設計・構築。実際に動かせる仕組みを作る。',
            },
            {
                icon: '💬',
        ...
        whoIsItFor: [
            'AIで自分のビジネスを加速したい方',
            '自分専用のAIチーム・ワークフローを構築したい方',
            'せいやに直接質問しながら、実装を進めたい方',
            '最新AIツールをいち早く、自分の現場に落としたい方',
        ],
    },
    {
        id: 'private',
        ...
        accentColor: '#1a1a3e',
        description: [
            '「せいやと1対1で、最深まで進めたい」——最も近い距離で、次元を変えたいあなたへ。',
            'アクセラレートプランの全てに加え、月1回60分の個別コンサルで、AI活用・ビジネス戦略・ビジョンの深化など何でも深堀りできます。',
            'せいやが開発する最新AIシステムは無料〜最優遇価格（50%以上OFF）で提供。さらに、VoiSlide Movie等のシステム開発プロセスをリアルタイムで公開。リアルイベントへの優先案内・割引もあり。',
            'せいやと最も近い距離で、ビジョンとビジネスを最深で進めていくプランです。',
        ],
        highlights: [
            {
                icon: '🎯',
                title: '個別コンサル（月1回、60分）',
                detail: 'Zoom形式。AI活用／ビジネス戦略／ビジョンの深化など、あなたのテーマに合わせて何でも相談OK。',
            },
            {
                icon: '🔑',
                title: '最新システムの最優遇提供',
        ...
        whoIsItFor: [
            'せいやと1対1で、ビジョンの次元そのものを変えたい方',
            '個別コンサルで、ビジネス戦略・AI活用を深めたい方',
            '最新AIシステムをいち早く、最優遇で使いたい方',
            'せいやがAIで形にしていく開発現場そのものに触れたい方',
        ],
    },
];
